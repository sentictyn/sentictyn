...
``` 
### - Im Developer **Php**, **Laravel**, **Java**, **JavaScript**, **Node.JS**, **React**, **Python**, **.NET Core**, **ASP.NET**, **C**, **C#**, **Ruby**, **Html** , **Css**, **Sass**, **Bash**, **jQuery** , **BootsTrap** and **Abode PS**...
...
[![My Skills](https://skills.thijs.gg/icons?i=php,laravel,java,js,nodejs,react,express,python,dotnet,c,cs,ruby,html,css,sass,bash,bootstrap,jquery,mysql,postgres,mongodb,cloudflare,ps&theme=light)](https://github.com/sentictyn)
#

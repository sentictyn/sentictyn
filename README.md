...
``` 
### - Im Developer **Php**, **Laravel**, **Java**, **JS(Java Script)**, **Node.JS**, **Express.JS**, **Vue.JS**, **Ejs.JS**, **Discord.JS**, **React**, **Python**, **PyQt**, **Selenium**, **Flask**, **.NET Core**, **ASP.NET**, **C**, **C#**, **jQuery**, **Ruby**, **Html**, **Css**, **Sass**, **Bash**, **BootsTrap**...

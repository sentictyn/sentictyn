...
``` 
### - Im Developer **Php**, **Laravel**, **Java**, **JS(Java Script)**, **Node.JS**, **Express.JS**, **Ejs.JS**, **Discord.JS**, **React**, **Python**, **PyQt**, **Selenium**, **Flask**, **.NET Core**, **ASP.NET**, **C**, **C#**, **Ruby**, **Html** , **Css**, **Sass**, **Bash**, **jQuery** , **BootsTrap** and **Abode PS**...
...
[![My Skills](https://skills.thijs.gg/icons?i=php,laravel,java,js,nodejs,react,express,nuxtjs,materialui,python,selenium,flask,qt,dotnet,c,cs,ruby,html,css,sass,bash,bootstrap,jquery,mysql,postgres,mongodb,sqlite,azure,redis,redux,git,postman,cloudflare,wordpress,visualstudio,vscode,ps,autocad&theme=light)](https://github.com/sentictyn)
#

...
``` 
### - Im Developer **Php**, **Laravel**, **Java**, **JS(Java Script)**, **Node.JS**, **React**, **Express.JS**, **Vue.JS**, **Ejs.JS**, **Discord.JS**, **Python**, **PyQt**, **Selenium**, **Flask**, **.NET Core**, **ASP.NET**, **C**, **C#**, **jQuery**, **Ruby**, **Html**, **Css**, **Sass**, **Bash**, **BootsTrap**...
...
[![My Skills](https://skills.thijs.gg/icons?i=php,laravel,java,js,nodejs,bots,react,express,nuxtjs,materialui,python,selenium,flask,qt,fastapi,dotnet,c,cs,ruby,html,css,sass,styledcomponents,bash,bootstrap,jquery,mysql,postgres,mongodb,sqlite,azure,redis,redux,git,regex,powershell,md,svg,postman,stackoverflow,cloudflare,wordpress,codepen,visualstudio,vscode,ps,autocad&theme=light)](https://github.com/sentictyn)
#

 ``` 
class Sentictyn {
    constructor(options) {
        this.discord = "SenticTyn#9999",
        this.name = "Sentic",
        this.age = "17",
        this.sex = "he / him",
        this.length = "1,80",
